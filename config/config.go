...
type Options struct {
	...
	Bootstrap            bool         `long:"bootstrap" description:"Bootstrap the server creating schema (if used with database), core users, their pem certificates exiting afterwards"`
